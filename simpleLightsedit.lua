...
--function doLight1()
	...
	-- l1 = osg.Light()
	-- l1:setAmbient(osg.Vec4(0.7, 0.7, 0.7, 0.7))
	-- ls1 = osg.LightSource()
	-- ls1:setLight(l1)
...
--function doLight1_5()
	...
	l3:setLinearAttenuation(.009)
	l3:setQuadraticAttenuation(.0005)
	...
	l3:setPosition(osg.Vec4(-4.0, 2.5, -3, 1.0))
		--RelativeTo.World:addChild(Sphere{radius=.23, position = {-1,0,1.25}})
--end
--function doLight2()

	l2 = osg.Light()
	l2:setLightNum(1)
	l2:setAmbient(osg.Vec4(.8, .8, 0.8, .50))
	...
	l2:setPosition(osg.Vec4(-4, 2, 1, 1.0))
	--RelativeTo.World:addChild(Sphere{radius=.23, position = {1.5,2,0}})
--end
